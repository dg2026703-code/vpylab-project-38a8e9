...
- 🌐 [GitHub Pages 실행 페이지](https://dg2026703-code.github.io/vpylab-project-38a8e9/)
- ▶️ [VPyLab에서 이 코드 실행](https://vpylab.vercel.app/sandbox?repo=dg2026703-code%2Fvpylab-project-38a8e9&autorun=1)
...
또는 GitHub에서 [`Commits`](https://github.com/dg2026703-code/vpylab-project-38a8e9/commits/main) 탭 클릭.
